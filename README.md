...
*   **On-demand Metadata:** Press `Shift+i` to toggle native file-size metadata next to files. `Ctrl+i` remains Yazi's `Spot` shortcut because terminals encode it as `Tab`.
